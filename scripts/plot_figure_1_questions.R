...
mtext(do.call(expression, sp_labels), side = 2, at = rev(1:nrow(question_tab)), las = 2, adj = 0.5, line = 3.25)
...
if (!presentation){
  for(line in nrow(ref_matrix):1){
    text(1:ncol(ref_matrix), line - 0.7, ref_matrix[25 - line,], pos = 3, cex = 0.875)
  }
}
